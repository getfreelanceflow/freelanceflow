...
router.post("/proposals/analyze-job", requireCredits("proposal_analyze_job"), async (req, res) => {
  try {
    const body = z
      .object({
...
router.post("/proposals/generate-draft", requireCredits("proposal_generate_draft"), async (req, res) => {
...
router.post("/proposals/regenerate", requireCredits("proposal_regenerate"), async (req, res) => {
  try {
    const body = z
      .object({
